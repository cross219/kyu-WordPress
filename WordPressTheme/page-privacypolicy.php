  ...
  <section class="page-privacypolicy lower-bg page-privacypolicy-layout">
    <div class="page-privacypolicy__inner inner">
      <div class="page-privacypolicy__body">
        <h3 class="page-privacypolicy__title">プライバシーポリシー</h3>
        <div class="page-privacypolicy__content">
          <div class="page-privacypolicy__block">
            <p class="page-privacypolicy__lead">
              以下は、Webサイトで使用するための一般的なプライバシーポリシーの例です。
            </p>
            <ol class="page-privacypolicy__list">
              <li class="page-privacypolicy__number">
                概要
          ...
          <div class="page-privacypolicy__block">
            ...
            <ol class="page-privacypolicy__list page-privacypolicy__list--mt0">
              <li class="page-privacypolicy__number">
                情報の使用
